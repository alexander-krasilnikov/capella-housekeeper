-- Schema version 2, frozen verbatim from SCHEMA_STATEMENTS plus MIGRATIONS[1]
-- in src/lib/db.ts, prior to the rename-age-status-to-recency change, with the
-- CLUSTER_RECORD_COLUMNS_SQL template literal expanded inline.
--
-- Do not edit. This is a historical artifact: it records what version 2
...
CREATE TABLE clusters (
  ...
  snoozeCount INTEGER NOT NULL, consentStatusChangedAtMs INTEGER, workflowNote TEXT,
...
CREATE TABLE history (
  ...
  , consentStatusChangedAtMs INTEGER, workflowNote TEXT);
